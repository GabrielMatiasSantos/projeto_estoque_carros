...
namespace estoque_carros.Serviços
{
    public class AbrirFormulárioServico : AbrirFormularioInterface
    {
        public bool AbrirFormularioCor(int id, string cor, CorServicoInterface corServico)
        {
           ...
           frmMarcaModeloCorAlterarDeletar formularioCor = new frmMarcaModeloCorAlterarDeletar(formularioDto, corServico);
        ...
        public bool AbrirFormularioMarca(int id, string marca, MarcaServicoInterface marcaServico)
        {
            ...
            frmMarcaModeloCorAlterarDeletar formularioMarca = new frmMarcaModeloCorAlterarDeletar(formularioDto, marcaServico);
        ...
        {
            Formulario1Dto formularioDto = new Formulario1Dto(715, "Modelo - Alterar/Excluir", "Modelo e versão:", true, true, true, true, true, true, 127,433);
