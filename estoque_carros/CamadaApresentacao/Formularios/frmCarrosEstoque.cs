...
namespace estoque_carros.CamadaApresentacao.Formularios
{
    ...
    {        
        private readonly AbrirFormularioInterface _formulario;
        ...
        private readonly CriarPdfServicoInterface _criarPdfServico;


        public frmCarrosEstoque(AbrirFormularioInterface formulario, CorServicoInterface corServico, MarcaServicoInterface marcaServico, ModeloServicoInterface modeloServico, CarroServicoInterface carroServico, CriarPdfServicoInterface criarPdfServico)
        {
            InitializeComponent();
