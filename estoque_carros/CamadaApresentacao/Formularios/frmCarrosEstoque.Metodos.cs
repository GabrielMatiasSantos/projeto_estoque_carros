...
namespace estoque_carros.CamadaApresentacao.Formularios
{
    public partial class frmCarrosEstoque 
    {
        ...
        public async Task CorDuploClique()
        {
            ...
            {
                bool atualizarDeletar = _formulario.AbrirFormularioCor(Convert.ToInt32(dgvCores.SelectedRows[0].Cells[0].Value), dgvCores.SelectedRows[0].Cells[1].Value.ToString(), _corServico);
        ...
        {
            Resultado2 verificar = _corServico.Verificar(txtCor.Text);
        ...
        private async Task PesquisarCor()
        {
            ...
            {
                Resultado1<List<CorDto>> resultado = await _corServico.PesquisarCor(txtCor.Text);
        ...
        {
            Resultado2 verificar = _marcaServico.Verificar(txtMarca.Text);
        ...
        private async Task MarcaDuploClique()
        {
            ...
            {
                bool atualizarDeletar = _formulario.AbrirFormularioMarca(Convert.ToInt32(dgvMarcas.SelectedRows[0].Cells[0].Value), dgvMarcas.SelectedRows[0].Cells[1].Value.ToString(), _marcaServico);
        ...
        private async Task PesquisarMarca()
        {
            ...
            {
                Resultado1<List<MarcaDto>> resultado = await _marcaServico.PesquisarMarca(txtMarca.Text);
        ...
        {
            Resultado2 verificar = _modeloServico.Verificar(Convert.ToInt32(cbModeloMarca.SelectedIndex), txtModelo.Text, cbModeloMotor.Text, cbModeloPortas.Text);
            ...
            if (verificar.Sucesso)
            {
                ...
                if (botao == DialogResult.Yes)
                {
                    Resultado2 resultado = await _modeloServico.InserirModelo(Convert.ToInt32(cbModeloMarca.SelectedValue), txtModelo.Text, cbModeloMotor.Text, cbModeloPortas.Text);
        ...
        private async Task PesquisarModelo()
        {
            ...
            {
                Resultado1<List<ModeloDto>> resultado = await _modeloServico.PesquisarModelo(txtModelo.Text);
